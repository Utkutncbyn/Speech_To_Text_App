...
user = os.getlogin()
image = Image.open(r"C:\Users\utku\Downloads\abra\Project-AI-Speech-To-Text\ai.jpg".format(user))
...
def CheckAll():
    os.remove(r"C:\Users\utku\Desktop\AbraAudioConverter\check_logs.json".format(user))
    ...
    for jsons in os.listdir(json_file_adress):
        ...
        if "Altyazı" in readed_json:
            with open(r"C:\Users\utku\Desktop\AbraAudioConverter\check_logs.json","a",encoding="utf8") as file:
